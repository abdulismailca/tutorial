...
class PaymentProvider(models.Model):
    ...
    multisafepay_api_key = fields.Char(
        string="API Key", help="The API key of the webservice user", required_if_provider='multisafepay',
        groups='base.group_system')
    multisafepay_client_key = fields.Char(
        string="Client Key", help="The client key of the webservice user",
        required_if_provider='multisafepay')
    multisafepay_hmac_key = fields.Char(
        string="HMAC Key", help="The HMAC key of the webhook", required_if_provider='multisafepay',
        groups='base.group_system')
    multisafepay_api_url_prefix = fields.Char(
